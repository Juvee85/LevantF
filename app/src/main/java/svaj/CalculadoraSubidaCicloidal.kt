 ...
 * leva en un segmento de subida con las funciones cicloidales
 */
class CalculadoraSubidaCicloidal: CalculadoraSVAJ {

    /**
     * Calcula el desplazamiento en la subida de una leva con la función cicloidal.
     *
     * La ecuación usada es:
     * $$h \left[\frac{\theta}{\beta} - \frac{1}{2\pi} sen\left(2\pi \frac{\theta}{\beta}\right)\right] + h_{i}$$
     * @usesMathJax
     */
