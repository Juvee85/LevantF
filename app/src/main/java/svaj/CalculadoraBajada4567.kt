 ...
 * leva en un segmento de bajada con las funciones polinomio 4-5-6-7
 */
class CalculadoraBajada4567 : CalculadoraSVAJ {

    /**
     * Calcula el desplazamiento en la bajada de una leva con la función 4-5-6-7
     *
     * La ecuación usada es:
     * $$h - h \left[35\left(\theta^{4} \over \beta^{4} \right) - 84\left(\theta^{5} \over \beta^{5} \right) + 70\left(\theta^{6} \over \beta^{6} - 20\left(\theta^{7} \over \beta^{7} \right) \right)\right] + \left(h_{i}-h\right)$$
     * @usesMathJax
     */
    override fun calcularDesplazamiento(
        ...
        return altura - (altura * (35*(x/beta).pow(4) - 84*(x/beta).pow(5) + 70*(x/beta).pow(6) - 20*(x/beta).pow(7))) + (alturaInicial-altura)
    }

    /**
     * Calcula la velocidad en la bajada de una leva con la función 4-5-6-7.
     *
     * La ecuación usada es:
    ...
    /**
     * Calcula la aceleración en la bajada de una leva con la función 4-5-6-7.
     *
     * La ecuación usada es:
    ...
    /**
     * Calcula el sacudimiento en la bajada de una leva con la función 4-5-6-7.
     *
     * La ecuación usada es:
