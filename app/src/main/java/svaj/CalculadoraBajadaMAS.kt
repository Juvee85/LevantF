 ...
 * leva en un segmento de bajada con las funciones MAS
 */
class CalculadoraBajadaMAS : CalculadoraSVAJ {

    /**
     * Calcula el desplazamiento en la bajada de una leva con la función MAS
     *
     * La ecuación usada es:
     * $$h - \frac{h}{2} \left[ 1 - cos\left(\pi \frac{\theta}{\beta} \right)\right] + \left(h_{i}-h\right)$$
     * @usesMathJax
     */
    ...
    /**
     * Calcula la velocidad en la bajada de una leva con la función MAS
     *
     * La ecuación usada es:
    ...
    /**
     * Calcula la aceleración en la bajada de una leva con la función MAS
     *
     * La ecuación usada es:
    ...
    /**
     * Calcula el sacudimiento en la bajada de una leva con la función MAS
     *
     * La ecuación usada es:
